...
<div class="w-full p-10 ">
    <div class="bg-white overflow-auto">
        <h1 class="text-base mt-8 mb-3 mx-12 md:text-xl lg:text-2xl font-semibold text-slate-700"> <span class="block font-bold text-slate-700 text-3xl">Data Budaya Tambaknegara</span></h1>
        <div class="leading-loose">

            <form action="/admin/kategori/budaya/save" method="POST" enctype="multipart/form-data" class="p-10 bg-white rounded shadow-xl">
                <?= csrf_field(); ?>
                <div class="mb-2">
                    <label class="block text-sm text-gray-600 mb-3  " for="nama">Nama Budaya</label>
                ...
                <div class="mb-2">
                    <label class="block text-sm text-gray-600 mb-3  " for="deskripsi">Deskripsi Budaya</label>
