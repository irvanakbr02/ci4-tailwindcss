...
<div class="w-full p-10 ">
    <div class="bg-white overflow-auto">
        ...
        <div class="leading-loose">
            ...
            <form action="/admin/laporan/save" method="POST" enctype="multipart/form-data" class="p-10 bg-white rounded shadow-xl">
                <?= csrf_field(); ?>
                <div class="mb-2">
                    <label class="block text-sm text-gray-600 mb-3  " for="judul">Judul</label>
                    <input class="<?= ($validation->hasError('judul')) ? 'is-invalid' : '' ?> w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="judul" name="judul" type="text" required="" placeholder="Judul Laporan..." aria-label="Name">
                </div>
                <div class="mt-2">
