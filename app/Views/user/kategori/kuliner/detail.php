    ...
    <div class="container">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="sm:w-full self-end p-6 ">
                <h1 class="text-base mb-2 md:text-xl lg:text-2xl font-semibold text-slate-300"> <span class="block font-bold text-slate-300 text-3xl"><?= $kuliner['nama']; ?></span></h1>
            </div>
            <div class="sm:w-full self-end p-6 ">
                <div class="overflow-x-auto relative shadow-md sm:rounded-lg mb-5 ">
                    <img src="/img/<?= $kuliner['foto']; ?>" alt=".. " class="img-fluid mb-6" />
