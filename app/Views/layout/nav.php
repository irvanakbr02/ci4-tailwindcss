            ...
            <div class="flex items-center px-4">
                ...
                <nav id="nav-menu" class="hidden absolute py-5 bg-slate-700 shadow-lg rounded-lg max-w-[250px] w-full right-5 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                    <ul class="block lg:flex">
                        <li class="group">
                            <a href="#home" class="text-base text-white py-2 mx-8 group-hover:text-slate-200 flex">Home</a>
                        </li>
                        <!-- Coba Flowbite -->
                        <li class="group">
                            <button id="dropdownNavbarButton" data-dropdown-toggle="dropdownNavbar" class="text-base text-white py-2 mx-8 group-hover:text-slate-200 flex">Profil <svg class="m-1 w-3 h-3" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div id="dropdownNavbar" class="hidden z-10 w-44 bg-slate-700 rounded divide-y divide-slate-100 shadow dark:bg-white dark:divide-white" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 412px);" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom">
                                <ul class="py-4 text-sm text-white hover:text-slate-700 dark:text-slate-400" aria-labelledby="dropdownNavbarButton">
                                    <li>
                                        <a href="#" class="text-base text-white py-2 mx-4 group-hover:text-slate-200 flex">Dashboard</a>
                                    </li>
                                    <li>
                                        <a href="#" class="text-base text-white py-2 mx-4 group-hover:text-slate-200 flex">Settings</a>
                                    </li>
                                    <li>
                                        <a href="#" class="text-base text-white py-2 mx-4 group-hover:text-slate-200 flex">Earnings</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="group">
                            <a href="#portofolio" class="text-base text-white py-2 mx-8 group-hover:text-slate-200 flex">Kontak</a>
                        </li>
                        <li class="group">
                            <a href="#clients" class="text-base text-white py-2 mx-8 group-hover:text-slate-200 flex">Berita</a>
                        </li>
                        <li class="group">
                            <a href="#blog" class="text-base text-white py-2 mx-8 group-hover:text-slate-200 flex">Laporan</a>
                        </li>
                        <li class="group">
                            <a href="#contact" class="text-base text-white py-2 mx-8 mb-1 group-hover:text-slate-200 flex">Kategori</a>
                        </li>
                        <li class="group">
